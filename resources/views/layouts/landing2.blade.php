...
<div id="navigation" class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><b>Historia Clinica</b></a>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="#home" class="smoothScroll">Home</a></li>
                <li><a href="#desc" class="smoothScroll">Link 1</a></li>
                <li><a href="#showcase" class="smoothScroll">Link 2</a></li>
                <li><a href="#contact" class="smoothScroll">Link 3</a></li>
            </ul>
...
<div id="footerwrap" class="col-xs-12 col-md-6">
    <div class="container">
        <div class="col-lg-5">
            <h3>Direccion:</h3>
            <p>
                1986 US 83 Business<br/>
                McAllen, TX<br/>
                78501<br/>
                United States
            </p>
        ...
        <div class="col-xs-12 col-md-7">
            ...
            <form role="form" action="#" method="post" enctype="plain">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="Mail" class="form-control" id="email1" placeholder="Ingresa tu Email">
                </div>
                <div class="form-group">
                    <label>Mensaje</label>
...
<div id="c">
    <div class="container">
        <p>
            <strong>Copyright &copy; 2015 <a href="http://deltainstall.com">larr86</a>.</strong>
            <br/>
            Historia Clinica {{ trans('adminlte_lang::message.createdby') }} Luis Ramirez <a href="http://deltainstall.com">larr86</a>
        </p>
